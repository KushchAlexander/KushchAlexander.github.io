...
(() => {
  ...
  function change() {
    ...
    if (selectChoice == 2) {
        ...
        <label for="onecomp">Дизель</label>\n \
        <input type="radio" id="twocomp" name="someGroupName" required="">\n \
        <label for="twocomp">Бензин 95</label> \
        ';
    }
        ...
        <label for="acryl">Заправиться</label>\n \
        <input type="checkbox" id="base">\n \
        <label for="base">Поменять масло</label>\n \
        <br />\n \
        <input type="checkbox" id="powder">\n \
        <label for="powder">Помыть кузов/салон</label> \
        ';
    }
  }
